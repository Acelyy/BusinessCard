...
import com.yonggang.liyangyang.businesscard.app_landscape.MyApplication;
...
public class DownLoadRunnable implements Runnable {
    ...
    public DownLoadRunnable(String url, int state, Handler handler) {
        this.url = url;
        this.state = state;
    ...
    public DownloadManager.Request CreateRequest(String url) {
        ...
        request.setTitle("农旅联盟一卡通");// 文件下载时显示的标题
