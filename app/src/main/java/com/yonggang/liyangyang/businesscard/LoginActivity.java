...
import com.yonggang.liyangyang.businesscard.request.GetVersion;
import com.yonggang.liyangyang.businesscard.request.LoginSever;
import com.yonggang.liyangyang.businesscard.response.LoginResult;
import com.yonggang.liyangyang.businesscard.response.Version;
import com.yonggang.liyangyang.businesscard.util.Constants;
import com.yonggang.liyangyang.businesscard.util.DownLoadRunnable;
import com.yonggang.liyangyang.businesscard.util.MD5;
import com.yonggang.liyangyang.businesscard.util.MyUtils;
                            ...
                            builder.setTitle("有新版本，是否更新")
                                    .setPositiveButton("确定", new DialogInterface.OnClickListener() {
                                        ...
                                        public void onClick(DialogInterface dialog, int which) {
                                            ...
                                            new Thread(new DownLoadRunnable(url,"农旅联盟一卡通", 0, handler)).start();
                                        }
